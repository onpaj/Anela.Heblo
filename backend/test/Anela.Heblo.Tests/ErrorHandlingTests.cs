...
public class ErrorHandlingTests
{
    ...
    public void ErrorCodes_ShouldFollowModulePrefixSystem()
    {
        ...
        var catalogDocumentsErrors = errorCodes.Where(code => code >= 3000 && code < 3100).ToList(); // 30XX range (CatalogDocuments)
        ...
        Assert.True(catalogDocumentsErrors.Count > 0, "Should have CatalogDocuments errors in 30XX range");
        ...
        var categorizedCount = generalErrors.Count + auditErrors.Count + purchaseErrors.Count +
                              ...
                              articleErrors.Count + leafletErrors.Count + photobankErrors.Count + smartsuppErrors.Count + inventoryErrors.Count + range29xxErrors.Count + catalogDocumentsErrors.Count + externalServiceErrors.Count;
