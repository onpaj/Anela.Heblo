...
public class ErrorHandlingTests
{
    ...
    public void ErrorCodes_ShouldFollowModulePrefixSystem()
    {
        ...
        var weatherErrors = errorCodes.Where(code => code >= 2900 && code < 3000).ToList(); // 29XX range
        ...
        Assert.True(weatherErrors.Count > 0, "Should have Weather forecast errors in 29XX range");
        ...
        var categorizedCount = generalErrors.Count + auditErrors.Count + purchaseErrors.Count +
                              ...
                              articleErrors.Count + leafletErrors.Count + photobankErrors.Count + smartsuppErrors.Count + inventoryErrors.Count + weatherErrors.Count + externalServiceErrors.Count;
