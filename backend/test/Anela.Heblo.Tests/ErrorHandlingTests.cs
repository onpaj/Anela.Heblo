...
public class ErrorHandlingTests
{
    ...
    public void ErrorCodes_ShouldFollowModulePrefixSystem()
    {
        ...
        var shipmentLabelsErrors = errorCodes.Where(code => code >= 2900 && code < 3000).ToList(); // 29XX range
        ...
        Assert.True(shipmentLabelsErrors.Count > 0, "Should have ShipmentLabels errors in 29XX range");
        ...
        var categorizedCount = generalErrors.Count + auditErrors.Count + purchaseErrors.Count +
                              ...
                              articleErrors.Count + leafletErrors.Count + photobankErrors.Count + smartsuppErrors.Count + inventoryErrors.Count + shipmentLabelsErrors.Count + externalServiceErrors.Count;
