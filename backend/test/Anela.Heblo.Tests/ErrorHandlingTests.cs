...
public class ErrorHandlingTests
{
    ...
    public void ErrorCodes_ShouldFollowModulePrefixSystem()
    {
        ...
        var categorizedCount = generalErrors.Count + auditErrors.Count + purchaseErrors.Count +
                              ...
                              articleErrors.Count + leafletErrors.Count + photobankErrors.Count + smartsuppErrors.Count + inventoryErrors.Count + range29xxErrors.Count + packagingErrors.Count + catalogDocumentsErrors.Count + authorizationErrors.Count + labelIdentificationErrors.Count + mindMapErrors.Count + externalServiceErrors.Count;
