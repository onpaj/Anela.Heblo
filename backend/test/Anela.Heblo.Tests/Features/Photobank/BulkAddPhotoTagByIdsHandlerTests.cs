...
public class BulkAddPhotoTagByIdsHandlerTests
{
    ...
    public BulkAddPhotoTagByIdsHandlerTests()
    {
        ...
        _handler = new BulkAddPhotoTagByIdsHandler(_photoRepositoryMock.Object, _tagRepositoryMock.Object, _photoTagRepositoryMock.Object, _cacheMock.Object);
    }
    ...
    public async Task Handle_HappyPath_AddsTagsAndReturnsCounts()
    {
        ...
        _tagRepositoryMock.Verify(r => r.GetOrCreateTagAsync("flowers", It.IsAny<CancellationToken>()), Times.Once);
    }
    ...
    public async Task Handle_DuplicatePhotoIdsProvided_DeduplicatesBeforeRepositoryCalls()
    {
        ...
        _photoRepositoryMock.Verify(r => r.CountExistingPhotosAsync(
        ...
        _photoRepositoryMock.Verify(r => r.GetExistingPhotoIdsMissingTagAsync(
            It.Is<IReadOnlyList<int>>(ids => ids.SequenceEqual(expectedDistinctIds)),
            5,
            It.IsAny<CancellationToken>()), Times.Once);
    }
