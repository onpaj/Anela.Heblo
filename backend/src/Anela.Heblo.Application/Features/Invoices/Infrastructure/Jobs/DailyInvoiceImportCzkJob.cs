...
public class DailyInvoiceImportCzkJob : IRecurringJob
{
    private readonly IInvoiceImportService _invoiceImportService;
    private readonly ILogger<DailyInvoiceImportCzkJob> _logger;
    ...
    public DailyInvoiceImportCzkJob(
        ...
        ILogger<DailyInvoiceImportCzkJob> logger,
    ...
    public async Task ExecuteAsync(CancellationToken cancellationToken = default)
    {
        ...
        await ImportYesterdayForCurrency("CZK", cancellationToken);
    }
