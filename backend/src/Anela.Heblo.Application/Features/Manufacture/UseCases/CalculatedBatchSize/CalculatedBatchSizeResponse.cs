...
public class CalculatedBatchSizeResponse : BaseResponse
{
    ...
    public CalculatedBatchSizeResponse() : base() { }

    public CalculatedBatchSizeResponse(ErrorCodes errorCode, Dictionary<string, string>? parameters = null) : base(errorCode, parameters) { }
}