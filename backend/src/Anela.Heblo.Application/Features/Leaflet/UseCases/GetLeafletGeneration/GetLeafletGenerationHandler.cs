...
public class GetLeafletGenerationHandler : IRequestHandler<GetLeafletGenerationRequest, GetLeafletGenerationResponse>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            return new GetLeafletGenerationResponse(ErrorCodes.LeafletFeedbackNotFound, new Dictionary<string, string>
            {
