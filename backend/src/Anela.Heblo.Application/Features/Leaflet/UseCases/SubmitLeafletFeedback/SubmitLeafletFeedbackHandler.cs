...
public class SubmitLeafletFeedbackHandler : IRequestHandler<SubmitLeafletFeedbackRequest, SubmitLeafletFeedbackResponse>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            return new SubmitLeafletFeedbackResponse(ErrorCodes.LeafletFeedbackNotFound, new Dictionary<string, string>
            {
        ...
        {
            return new SubmitLeafletFeedbackResponse(ErrorCodes.Forbidden, new Dictionary<string, string>
            {
                { "generationId", request.GenerationId.ToString() }
            });
        }
        ...
        {
            return new SubmitLeafletFeedbackResponse(ErrorCodes.LeafletFeedbackAlreadySubmitted, new Dictionary<string, string>
            {
                { "generationId", request.GenerationId.ToString() }
            });
        }
