...
public class GetLeafletFeedbackListHandler : IRequestHandler<GetLeafletFeedbackListRequest, GetLeafletFeedbackListResponse>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            Logs = items.Select(g => new LeafletGenerationSummary
            {
                Id = g.Id,
                Topic = g.Topic,
                Audience = g.Audience,
