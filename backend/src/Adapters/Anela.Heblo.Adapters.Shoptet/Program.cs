...
var source = new ShoptetPlaywrightExpeditionListSource(new PrintPickingListScenario(options, new PlaywrightBrowserFactory(options), log, TimeProvider.System));
await source.CreatePickingList(new PrintPickingListRequest(), null, CancellationToken.None);
