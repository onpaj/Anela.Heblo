...
public static class ShoptetPayAdapterServiceCollectionExtensions
{
    public static IServiceCollection AddShoptetPayAdapter(this IServiceCollection services, IConfiguration configuration)
    {
