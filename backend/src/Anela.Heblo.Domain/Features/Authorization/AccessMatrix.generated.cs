...
public static class AccessMatrix
{
    ...
    public static readonly IReadOnlyList<FeatureDefinition> Features = new[]
    {
        ...
        new FeatureDefinition(Feature.Warehouse_GiftPackages, "Dárkové balíčky", HasWrite: true),
        new FeatureDefinition(Feature.Warehouse_StockOverride, "Přepsání kontroly zásob"),
    ...
    public static readonly IReadOnlyList<MenuPath> MenuPaths = new[]
    {
        ...
        new MenuPath("/logistics/gift-package-manufacturing", new FeaturePermission[] { new FeaturePermission(Feature.Warehouse_GiftPackages, AccessLevel.Read) }),
        ...
        new MenuPath("/marketing/performance", new FeaturePermission[] { new FeaturePermission(Feature.Marketing_Performance, AccessLevel.Read) }),
        ...
        new MenuPath("/automation/mind-maps", new FeaturePermission[] { new FeaturePermission(Feature.Anela_MindMaps, AccessLevel.Read) }),
        new MenuPath("#org-chart", new FeaturePermission[] { new FeaturePermission(Feature.Anela_OrgChart, AccessLevel.Read) }),
        new MenuPath("/overtime", new FeaturePermission[] { new FeaturePermission(Feature.Attendance_Overtime, AccessLevel.Read) }),
