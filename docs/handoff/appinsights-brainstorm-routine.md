...
[`docs/routines/telemetry-brainstorm.md`](../routines/telemetry-brainstorm.md) →
...
./scripts/monitoring/brainstorm-telemetry.sh
./scripts/monitoring/brainstorm-telemetry.sh --timespan P1D
```
