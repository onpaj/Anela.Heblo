# Task Plan: Extract `ITimeWindowParser` interface in Analytics module

Source artifacts: `artifacts/feat-3464/spec.r1.md`, `artifacts/feat-3464/arch-review.r1.md`, `artifacts/feat-3464/design.r1.md`.

This is a single-concern, no-behavior-change refactor (DIP fix). One task covers it end-to-end.
