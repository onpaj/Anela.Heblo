# Task Plan: Unit test coverage for LowStockEfficiencyTile

## Overview
Add a focused unit test suite for `LowStockEfficiencyTile.LoadDataAsync`, covering the low-stock-efficiency filter's business rule, its exclusive 20% boundary, and its error-response branch. No production code changes.
