                                  ...
                                  <span className="text-sm text-gray-900">
                                    {orderData.contactVia === "Phone"
                                      ...
                                      : orderData.contactVia === "Email"
                                        ? "Email"
                                        : orderData.contactVia === "WhatsApp"
                                          ? "WhatsApp"
                                          : orderData.contactVia === "F2F"
                                            ? "Osobně"
                                            : orderData.contactVia === "Eshop"
                                              ? "Eshop"
                                              : orderData.contactVia === "Other"
                                                ? "Jiné"
                                                : orderData.contactVia}
                                  </span>
                                </div>
                              ...
                              <div className="flex justify-between items-center">
                                ...
                                <div className="flex items-center gap-2">
                                  ...
                                  <button
                                    ...
                                    disabled={
                                      updateInvoiceAcquiredMutation.isPending
                                    }
