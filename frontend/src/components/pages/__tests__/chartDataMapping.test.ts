import { CatalogSalesRecordDto, CatalogConsumedRecordDto } from '../../../api/hooks/useCatalog';
...
describe('Chart Data Mapping', () => {
  ...
  it('should map sales data correctly for current and previous months', () => {
    const salesData: CatalogSalesRecordDto[] = [
      { year: 2025, month: 8, amountTotal: 50, amountB2B: 30, amountB2C: 20, sumTotal: 5000, sumB2B: 3000, sumB2C: 2000 }, // Current month
      { year: 2025, month: 7, amountTotal: 40, amountB2B: 25, amountB2C: 15, sumTotal: 4000, sumB2B: 2500, sumB2C: 1500 }, // Last month
      { year: 2024, month: 9, amountTotal: 35, amountB2B: 20, amountB2C: 15, sumTotal: 3500, sumB2B: 2000, sumB2C: 1500 }, // 11 months ago
      { year: 2024, month: 8, amountTotal: 30, amountB2B: 18, amountB2C: 12, sumTotal: 3000, sumB2B: 1800, sumB2C: 1200 }, // 12 months ago
    ];
  ...
  it('should handle year transitions correctly', () => {
    ...
    const salesData: CatalogSalesRecordDto[] = [
      { year: 2024, month: 2, amountTotal: 100, amountB2B: 60, amountB2C: 40, sumTotal: 10000, sumB2B: 6000, sumB2C: 4000 }, // 11 months ago
      { year: 2024, month: 1, amountTotal: 80, amountB2B: 50, amountB2C: 30, sumTotal: 8000, sumB2B: 5000, sumB2C: 3000 }, // 12 months ago
    ];
  ...
  it('should handle data with zero values', () => {
    const salesData: CatalogSalesRecordDto[] = [
      { year: 2025, month: 8, amountTotal: 0, amountB2B: 0, amountB2C: 0, sumTotal: 0, sumB2B: 0, sumB2C: 0 },
      { year: 2025, month: 7, amountTotal: 50, amountB2B: 30, amountB2C: 20, sumTotal: 5000, sumB2B: 3000, sumB2C: 2000 },
    ];
  ...
  it('should handle missing properties gracefully', () => {
    const malformedData = [
      ...
      { year: 2025, month: 7, amountTotal: 30, amountB2B: 20, amountB2C: 10, sumTotal: 3000, sumB2B: 2000, sumB2C: 1000 },
    ];
