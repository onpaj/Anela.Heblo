...
const TransportBoxDetail: React.FC<TransportBoxDetailProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50">
      <div
        className="relative top-2 mx-auto p-3 border dark:border-graphite-border w-11/12 max-w-7xl shadow-lg dark:shadow-soft-dark rounded-md bg-white dark:bg-graphite-surface mb-4 flex flex-col"
