 ...
 */
export const catalogItemToMaterial = (item: CatalogItemDto): MaterialForPurchaseDto => ({
 ...
 */
export const materialDisplayValue = (material: MaterialForPurchaseDto): string => {
...
export const PRODUCT_TYPE_FILTERS = {
  ...
  PURCHASE_MATERIALS: [ProductType.Material, ProductType.Goods] as ProductType[],
  
  // For manufacturing - materials and semi-products
  MANUFACTURING: [ProductType.Material, ProductType.SemiProduct] as ProductType[],
