...
const MarginsChart: React.FC<MarginsChartProps> = ({
  ...
  const percentageDatasets = hasM0M3Data ? [
    ...
    },
    {
      ...
      borderWidth: 2,
      tension: 0.1,
      pointBackgroundColor: m1_AStyling.pointBackgroundColors,
      pointBorderColor: m1_AStyling.pointBackgroundColors,
      pointRadius: m1_AStyling.pointRadiuses,
      pointHoverRadius: m1_AStyling.pointHoverRadiuses,
      yAxisID: "y1",
      fill: false,
    },
    {
