...
export default function FolderStatusBanner({ status, expectedPrefix, basePath }: FolderStatusBannerProps) {
  ...
  if (status === 'MultipleMatches') {
    return (
      <div className="rounded-md bg-yellow-50 border border-yellow-200 px-4 py-3 text-sm text-yellow-800 dark:bg-amber-900/30 dark:border-amber-800/40 dark:text-amber-300">
  ...
  return (
    <div className="rounded-md bg-gray-50 border border-gray-200 px-4 py-3 text-sm text-gray-600 dark:bg-graphite-surface-2 dark:border-graphite-border dark:text-graphite-muted">
