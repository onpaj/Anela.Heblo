...
import { FileText, ShoppingCart, TrendingUp, BookOpen, ArrowRight } from 'lucide-react';
...
interface CatalogDetailTabsProps {
  ...
  onTabChange: (tab: 'basic' | 'history' | 'margins' | 'journal' | 'usage') => void;
  detailData: any;
  isLoading: boolean;
  ...
  return (
    <div className="flex flex-col overflow-hidden">
      ...
      <div className="flex border-b border-gray-200 mb-6">
        ...
        {(item?.type === ProductType.Product || item?.type === ProductType.SemiProduct || item?.type === ProductType.Goods) && (
          <button
