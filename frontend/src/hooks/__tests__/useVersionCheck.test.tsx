...
describe('useVersionCheck', () => {
  ...
  it('should show notification when new version is detected', () => {
    let onNewVersionCallback: (newVersion: string, currentVersion: string) => void;
  ...
  it('should handle version check errors gracefully', async () => {
    ...
    mockVersionService.hasNewVersion.mockRejectedValue(new Error('Check failed'));
    ...
    expect(consoleSpy).toHaveBeenCalledWith('Manual version check failed:', expect.any(Error));
  ...
  it('should handle initialization errors gracefully', async () => {
    const consoleSpy = jest.spyOn(console, 'error').mockImplementation(() => {});
    mockVersionService.initializeVersion.mockRejectedValue(new Error('Init failed'));
    ...
    expect(consoleSpy).toHaveBeenCalledWith('Version initialization failed:', expect.any(Error));
